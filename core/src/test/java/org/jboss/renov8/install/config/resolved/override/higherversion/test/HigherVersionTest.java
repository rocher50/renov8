...
package org.jboss.renov8.install.config.resolved.override.higherversion.test;
...
public class HigherVersionTest extends ResolvedInstallTestBase {
    ...
    private static final PackLocation E_3 = PackLocation.create("E", new StrVersion("3"));
    ...
    private static final PackLocation H_1 = PackLocation.create("H", new StrVersion("1"));
    ...
    protected void initPackSpecs() throws Exception {
        ...
        writePackSpec(PackSpec.builder(E_2)
                .addDependency(H_1)
                .build());
        writePackSpec(PackSpec.builder(E_3).build());
        ...
        writePackSpec(PackSpec.builder(H_1).build());
    }
    ...
    protected ResolvedInstall resolvedInstall() {
        return ResolvedInstall.builder()
                .addPack(ResolvedPack.forLocation(E_3))
                ...
                .addPack(ResolvedPack.builder(C_1)
                        .addDependency(E_3.getPackId().getProducer())
                        .addDependency(F_1.getPackId().getProducer())
                        .build())
                .build();
    }
